import {PiTelegramLogoDuotone, PiTelegramLogoFill, 
  PiLinkedinLogo, PiLinkedinLogoFill,
  PiDiscordLogoFill, PiDiscordLogo,
  PiCalendarCheckDuotone, PiCalendarCheckFill} from 'react-icons/pi';
...
const Linktr = () => {
  return (
    <div className=' bg-rose-300 w-fit mt-2 py-1 px-4 border border-gray-700 mx-auto rounded hover:shadow-lg'>
      <p className='flex font-bold text-3xl w-full'>Reach us on</p>
      <br/>
      <ul className=" text-xl">
        <li className='group relative w-min'>
          <a href={"https://t.me/berkerz"} target="_blank" rel="noopener noreferrer" className='flex items-center'>
        ...
        <li className='group relative w-min'>
          <a href={"https://www.linkedin.com/in/cryptofinomic/"} target="_blank" rel="noopener noreferrer" className='flex items-center'>
